...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    public void changePriority(T item, double priority) {
        ...
        if (idx == size + 1) {
            throw new IllegalArgumentException("no such item in heap");
        }
        curNode.myPriority = priority;
        swim(idx);
        sink(idx);
    }
